...
// import 'package:nvc_cinemas/shared/http/api_exception.dart';
// import 'package:nvc_cinemas/shared/http/api_provider.dart';
// import 'package:nvc_cinemas/shared/http/api_response.dart';
...
//   ProfileNotifier(this._reader) : super(const Profile()) {
//     fetchProfile();
//   }
//
...
//       try {
//         final _profile = profileFromJson(data as Map<String, dynamic>);
//         state = _profile;
//         await _reader(languageRepositoryProvider)
//             .saveLanguage(state.language ?? 'vi');
//         await ProfileRepository().saveProfile(state);
//         // _reader(languageProvider.notifier).update(state.language ?? 'vi');
//       } catch (e) {
//         APIException.errorWithMessage(e.toString());
//       }
//     }
//   }
//
//   String? getNameCharacter() {
//     final words = state.name?.split(' ');
//
...
//   }
//
//   Future<void> refresh(WidgetRef ref, BuildContext context) async {
//     await fetchProfile();
